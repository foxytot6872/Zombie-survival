...
class BasicZombie(Enemy):
    ...
    def __init__(self, pos: Tuple[float, float], hp: Optional[int] = None, sprite_sheet=None):
        ...
        # Use cached sprite sheet from EnemyAssets (loaded once at game start)
        self.sprite_sheet = EnemyAssets.zombie_sprite_sheet
        if sprite_sheet is not None:
            self.sprite_sheet = sprite_sheet  # Allow override for compatibility
        
        # Load animation frames from cache (or create if first time)
        ...
        # Animation state (will be reset in on_reset)
    ...
    def load_animation_frames(self):
        ...
        # No-op: frames are loaded from cache in __init__
        pass
    ...
    def draw_body(self, surface: pygame.Surface):
        """Draw zombie body using sprite sheet"""
    ...
    def draw(self, surface: pygame.Surface):
        """Draw the zombie - override to allow drawing dead zombies during death animation"""
